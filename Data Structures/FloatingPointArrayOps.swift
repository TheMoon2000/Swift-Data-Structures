...
/*
 This file generalizes the extensions in the `DoubleArrayOperations.swift` file to all floating point types. The reason why `DoubleArrayaOperations.swift` is still necessary is because by specifying Doubles as the data type the code runs slightly faster.
 */
